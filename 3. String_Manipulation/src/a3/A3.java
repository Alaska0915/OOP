...
public class A3 {
    ...
    public static String surroundLittles(String s) {
        ...
        for (int i= 0; i < len; i++ ) {
            if (s.charAt(i) >= 'a' && s.charAt(i) <= 'z') {
                sur= sur + Character.toUpperCase(s.charAt(i)) + s.charAt(i) +
    ...
    * duplicate("35")          is "33333". */
    public static String duplicate(String s) {
        ...
        int index= s.indexOf(s.trim());
        int k= Character.getNumericValue(s.charAt(index + 1));
